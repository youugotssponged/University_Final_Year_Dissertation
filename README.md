...
D.O.T.S is Data Oriented Based, to which follows a SoA memory layout (Structure of Arrays)

OOP and DoD will be compared in terms of SoA vs AoS (Array of Structures)
...
- Same mount of Objects within the scenes.
- Same Textures being rendered within the scenes.
- Same Character Controller Package.
- Same UI Feedback .
